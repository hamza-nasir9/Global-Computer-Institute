  ...
  return (
    <section className="py-12 md:py-24 px-4 sm:px-6 md:px-16" style={{ backgroundColor: 'var(--bg-section)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        {/* Heading - Wapas Add Kiya (Same as original) */}
        <div className="text-center mb-12 md:mb-16">
          <span className="text-[#D4A017] text-sm uppercase tracking-wider font-semibold">Latest Updates</span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-2 mb-4" style={{ color: 'var(--text-primary)' }}>
            Events & <span className="text-[#D4A017]">News</span>
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">
            Stay in the loop with GCI's latest events, workshops, and announcements.
          </p>
        </div>
        ...
        <div ref={ctaRef} className="mt-8 md:mt-12 rounded-2xl border p-5 md:p-7 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-5"
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
            ...
            />
            <button className="bg-gold-gradient text-black font-bold px-5 md:px-6 py-2.5 rounded-full text-xs md:text-sm whitespace-nowrap transition-transform duration-200 hover:scale-105 active:scale-95" style={{ boxShadow: 'var(--shadow-gold-sm)' }}>
              Subscribe
            </button>
          </div>
        </div>
