    ...
    <section className="py-12 md:py-24 px-4 sm:px-6 md:px-16" style={{ backgroundColor:'var(--bg-section)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10 md:mb-16">
          <span className="text-[#D4A017] text-xs md:text-sm uppercase tracking-wider font-semibold">Why GCI</span>
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mt-2 mb-3" style={{ color:'var(--text-primary)' }}>
            Why Students Choose <span className="text-[#D4A017]">Us Over Others</span>
          </h2>
          <p className="text-gray-500 text-sm md:text-base max-w-2xl mx-auto">
            We don't just teach technology — we shape careers, build confidence, and create the next generation of Pakistan's tech leaders.
          </p>
        </div>
        ...
        <div ref={ctaRef} className="mt-10 md:mt-14 rounded-2xl border p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-5 md:gap-6"
          ...
          <div className="flex gap-3 flex-shrink-0">
            <a href="/admissions" className="bg-gold-gradient text-black font-bold px-5 md:px-7 py-2.5 md:py-3 rounded-full text-xs md:text-sm transition-transform duration-200 hover:scale-105 hover:-translate-y-0.5 whitespace-nowrap" style={{ boxShadow:'var(--shadow-gold-sm)' }}>
              Apply Now
            </a>
            <a href="tel:+922111524786" className="inline-flex items-center gap-1.5 border font-semibold px-5 md:px-7 py-2.5 md:py-3 rounded-full text-xs md:text-sm transition-all duration-300 hover:border-[#D4A017]/50 whitespace-nowrap"
