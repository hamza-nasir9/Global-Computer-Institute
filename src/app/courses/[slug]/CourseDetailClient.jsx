  ...
  return (
    <>
      ...
      <main style={{ backgroundColor:'var(--bg-primary)' }}>
        {/* Hero */}
        <section className="relative h-[500px] md:h-[560px] flex items-end overflow-hidden bg-[#0a0a0a]">
            ...
            <div ref={sidebarRef} className="lg:col-span-1 gsap-hidden">
              <div className="sticky top-24 rounded-3xl border overflow-hidden" style={{ backgroundColor:'var(--bg-card)', borderColor:'var(--border-gold)', boxShadow:'var(--shadow-card)' }}>
                ...
                <div className="p-6">
                  ...
                  <a href="/admissions" className="flex items-center justify-center gap-2 w-full bg-gold-gradient text-black font-black py-3.5 rounded-2xl text-sm mb-3 transition-transform duration-200 hover:scale-[1.02] hover:-translate-y-0.5" style={{ boxShadow:'var(--shadow-gold)' }}>
                    <GraduationCap size={17} />Enroll Now
                  </a>
                  <a href="tel:+922111424786" className="flex items-center justify-center gap-2 w-full py-3 rounded-2xl text-xs font-semibold border transition-colors"
